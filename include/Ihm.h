...
Encoder_Data    Tab_Encoder[MAX_SECTION][MAX_ENCODER]=
{
    ...
    "WAV",  "WAVE FILE",      MIDI_CC_WAVE1,  TYPE_DATA,  &TabListNull[0][0], 0,    &WS.GraIdWave,      1,    0,      127,1,                    Fct_Ch_GraWave,       
    ...
    "DEN",  "GRAIN DENSITY",  MIDI_CC_WS1,    TYPE_DATA,  &TabListNull[0][0], 0,    &WS.GraSize,        1,    1,      10 ,1,                    Fct_Ch_GraDensity,              
